...
namespace Infrastructure.Migrations.NotificationDb
{
    ...
    [Migration("20241223204235_NotificationLogTableCreate")]
    partial class NotificationLogTableCreate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Notifications.NotificationChannel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 23, 20, 42, 34, 425, DateTimeKind.Utc).AddTicks(353),
                            IsDeleted = false,
                            Name = "EMAIL"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 23, 20, 42, 34, 425, DateTimeKind.Utc).AddTicks(360),
                            IsDeleted = false,
                            Name = "SMS"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 23, 20, 42, 34, 425, DateTimeKind.Utc).AddTicks(363),
                            IsDeleted = false,
                            Name = "PUSH"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Notifications.NotificationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Notifications.NotificationLog", b =>
                {
                    b.HasOne("Domain.Notifications.NotificationChannel", "NotificationChannel")
                        .WithMany()
